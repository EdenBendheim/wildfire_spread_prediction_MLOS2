...
# ─── CONFIG ─────────────────────────────────────────────────────────────────────
LARGEFIRE_GPKG  = "Largefire/LargeFires_2012-2020.gpkg"
LARGEFIRE_LAYER = "perimeter"
...
def load_fire_footprints():
    """Load all fires from LargeFires layer with their date and geometry."""
    gdf = gpd.read_file(LARGEFIRE_GPKG, layer=LARGEFIRE_LAYER)
    if "time" in gdf.columns:
        ...
        raise KeyError("No 'time' or 'date' column in LargeFires layer")
